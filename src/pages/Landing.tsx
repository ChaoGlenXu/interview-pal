...
import { Mic, Sparkles, BarChart3, Clock, ArrowRight, CheckCircle, Building2, Briefcase, Users, Target } from 'lucide-react';
  ...
  const useCases = [
    {
      ...
      description: 'Practice and perfect your interview skills before the real thing. Get AI-powered feedback to improve your responses.',
    ...
    },
    {
      icon: Building2,
      title: 'For Companies',
      description: 'Screen candidates efficiently with AI-powered interviews. Save time while maintaining quality assessments.',
        ...
        <div className="container relative z-10 py-24 lg:py-32">
          <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mb-10 animate-slide-up" style={{ animationDelay: '0.1s' }}>
              Whether you're preparing for your dream job or screening top talent, 
              our AI voice agent delivers realistic interview experiences with instant feedback.
            </p>
